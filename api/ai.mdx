---
title: "REST API endpoints for AI classification — BaBel+ API reference"
sidebarTitle: "AI"
...
<ResponseField name="node" type="Node">
  The fully persisted `Node` object, including its generated UUID, `createdAt`, `updatedAt`, and all database fields (e.g., `localFile`, `rating`).
</ResponseField>
