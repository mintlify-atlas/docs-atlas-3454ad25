---
title: "BaBel+ REST API overview — endpoints and conventions"
sidebarTitle: "Overview"
description: "BaBel+ REST API built with Hono. All endpoints live under /api, return JSON, and require no authentication in the current server version."
---
