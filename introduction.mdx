...
description: "BaBel+ is a self-hosted knowledge graph for cataloging books, films, articles, and more as nodes connected by typed semantic relations."
---
...
BaBel+ recognises six content types out of the box:
