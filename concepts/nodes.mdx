...
sidebarTitle: "Nodes"
description: "Nodes are BaBel+'s atomic content units. Learn all six node types, every metadata field, the four statuses, and how they render in the graph canvas."
---
